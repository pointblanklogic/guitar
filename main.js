...
var author$project$Main$Model = F7(
	function (currentPage, navKey, the12Notes, confirmation, paidStatus, accessCode, currentDate) {
		return {accessCode: accessCode, confirmation: confirmation, currentDate: currentDate, currentPage: currentPage, navKey: navKey, paidStatus: paidStatus, the12Notes: the12Notes};
	});
...
var author$project$Main$getTodaysDate = A2(elm$core$Task$perform, author$project$Main$ReceiveDate, justinmimbs$date$Date$today);
	...
	function (_n0, url, key) {
		return _Utils_Tuple2(
			A7(
				...
				'',
				A3(justinmimbs$date$Date$fromCalendarDate, 2019, elm$time$Time$Jan, 1)),
			elm$core$Platform$Cmd$batch(
				_List_fromArray(
					[
						author$project$Main$getTodaysDate,
						A2(elm$browser$Browser$Navigation$pushUrl, key, '/home')
					])));
	});
var author$project$Main$About = {$: 'About'};
var author$project$Main$Buy = {$: 'Buy'};
var author$project$Main$ContactInfo = {$: 'ContactInfo'};
var author$project$Main$Medium = {$: 'Medium'};
var author$project$Main$Premium = {$: 'Premium'};
var author$project$Main$Small = {$: 'Small'};
var author$project$Main$GotConfirmation = function (a) {
	return {$: 'GotConfirmation', a: a};
};
...
var author$project$Main$getConfirmationCommand = elm$http$Http$request(
	{
		body: elm$http$Http$emptyBody,
		expect: elm$http$Http$expectString(author$project$Main$GotConfirmation),
		headers: _List_Nil,
		method: 'GET',
		timeout: elm$core$Maybe$Nothing,
		tracker: elm$core$Maybe$Nothing,
		url: 'https://pk_test_cCLW8WQdlrDULDSln7lFCFKC00TigHAcIq:@api.stripe.com/v1/events?limit=3'
	});
...
var author$project$Main$removeNote = F2(
	function (theNote, the12Notes) {
		var listTuple = A2(
			elm$core$List$partition,
			function (x) {
				return _Utils_eq(x, theNote);
			},
			the12Notes);
		return listTuple.b;
	});
...
var author$project$Main$replace12NotesList = F3(
	function (model, which12NotesList, newList) {
		var secondPart = A2(elm$core$List$drop, which12NotesList + 1, model.the12Notes);
		var firstPart = A2(elm$core$List$take, which12NotesList, model.the12Notes);
		return _Utils_ap(
			firstPart,
			_Utils_ap(
				_List_fromArray(
...
var author$project$Main$select12NotesList = F2(
	function (model, which12NotesList) {
		var maybeListResult = elm$core$List$head(
			A2(elm$core$List$drop, which12NotesList, model.the12Notes));
		if (maybeListResult.$ === 'Just') {
			var listResult = maybeListResult.a;
			return listResult;
		} else {
			return _List_Nil;
		}
		...
		switch (msg.$) {
			...
			case 'GoBuy':
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{currentPage: author$project$Main$Buy}),
					A2(elm$browser$Browser$Navigation$pushUrl, model.navKey, '/prices'));
			case 'GoAbout':
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{currentPage: author$project$Main$About}),
					A2(elm$browser$Browser$Navigation$pushUrl, model.navKey, '/about'));
			case 'GoContactInfo':
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{currentPage: author$project$Main$ContactInfo}),
					A2(elm$browser$Browser$Navigation$pushUrl, model.navKey, '/contact_info'));
			case 'AddRemove':
				var which12NotesList = msg.a;
				var theNote = msg.b;
				var theCurrentList = A2(author$project$Main$select12NotesList, model, which12NotesList);
				var newList = A2(elm$core$List$member, theNote, theCurrentList) ? A2(author$project$Main$removeNote, theNote, theCurrentList) : A2(elm$core$List$cons, theNote, theCurrentList);
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{
							the12Notes: A3(author$project$Main$replace12NotesList, model, which12NotesList, newList)
						}),
					elm$core$Platform$Cmd$none);
			case 'GetConfirmation':
				return _Utils_Tuple2(model, author$project$Main$getConfirmationCommand);
			case 'GotConfirmation':
				var response = msg.a;
				if (response.$ === 'Ok') {
					var confirmationData = response.a;
					return _Utils_Tuple2(
						_Utils_update(
							model,
						...
						case 'BadStatus':
							...
							return _Utils_Tuple2(
								_Utils_update(
									model,
									{
										confirmation: elm$core$String$fromInt(code)
									}),
								elm$core$Platform$Cmd$none);
						case 'BadBody':
							var message = response.a.a;
			...
			case 'ChangePaidStatus':
				...
				return _Utils_Tuple2(
					...
					elm$core$Platform$Cmd$none);
			case 'RecordAccessCode':
				var accessCodeInputed = msg.a;
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{accessCode: accessCodeInputed}),
					elm$core$Platform$Cmd$none);
			case 'ProcessAccess':
				var current_year = justinmimbs$date$Date$year(model.currentDate);
				var current_month = justinmimbs$date$Date$month(model.currentDate);
				var accessCode_sha256_signature = billstclair$elm_sha256$Sha256$sha256(model.accessCode);
				switch (accessCode_sha256_signature) {
					case '8d16498453b03d4420d90362d71e6c36bb1564aeea53f36f206746e7cb5a5175':
						return ((_Utils_eq(current_month, elm$time$Time$Sep) || _Utils_eq(current_month, elm$time$Time$Oct)) && (current_year === 2019)) ? _Utils_Tuple2(
							_Utils_update(
								model,
								{paidStatus: author$project$Main$Small}),
							elm$core$Platform$Cmd$none) : _Utils_Tuple2(model, elm$core$Platform$Cmd$none);
					case '4efdac93aa5c18773028b58c29901de6bc13cf3491b42b3f8a2787b85bfbad2f':
						return ((_Utils_eq(current_month, elm$time$Time$Sep) || _Utils_eq(current_month, elm$time$Time$Oct)) && (current_year === 2019)) ? _Utils_Tuple2(
							_Utils_update(
								model,
								{paidStatus: author$project$Main$Medium}),
							elm$core$Platform$Cmd$none) : _Utils_Tuple2(model, elm$core$Platform$Cmd$none);
					case '6d785acc7d4ce49fe4e4bbf276dc73f1cf7c20094d3e96fe84ef79fbebcaf88a':
						return ((_Utils_eq(current_month, elm$time$Time$Sep) || _Utils_eq(current_month, elm$time$Time$Oct)) && (current_year === 2019)) ? _Utils_Tuple2(
							_Utils_update(
								model,
								{paidStatus: author$project$Main$Premium}),
							elm$core$Platform$Cmd$none) : _Utils_Tuple2(model, elm$core$Platform$Cmd$none);
					default:
						return _Utils_Tuple2(model, elm$core$Platform$Cmd$none);
				}
			case 'OneMoreFretboard':
				var oldList = model.the12Notes;
				...
				return _Utils_Tuple2(
					_Utils_update(
						...
						{the12Notes: newList}),
					elm$core$Platform$Cmd$none);
			case 'OneLessFretboard':
				var oldList = model.the12Notes;
				var newList = (elm$core$List$length(oldList) < 3) ? oldList : A2(
					elm$core$List$take,
					elm$core$List$length(oldList) - 1,
					oldList);
				return _Utils_Tuple2(
					_Utils_update(
						model,
...
var author$project$Main$element_display_confirmation = function (data) {
...
var author$project$Main$element_footer = function (model) {
	var current_year = justinmimbs$date$Date$year(model.currentDate);
	return A2(
		...
		_List_fromArray(
			[
				...
				mdgriffith$elm_ui$Element$text(
					'Copyright (c) ' + (elm$core$String$fromInt(current_year) + ', POINT BLANK Logic.(tm)   |   www.pointblanklogic.com  ')))
			]));
};
var author$project$Main$ProcessAccess = {$: 'ProcessAccess'};
var author$project$Main$RecordAccessCode = function (a) {
	return {$: 'RecordAccessCode', a: a};
};
...
var author$project$Main$element_formAccessCode = function (model) {
	return A2(
		mdgriffith$elm_ui$Element$column,
		_List_Nil,
		_List_fromArray(
			[
				...
				_List_Nil,
				{
					label: A2(
						...
						_List_Nil,
						mdgriffith$elm_ui$Element$text(' To access your subscription features, enter the email address you used when you subscribed or\n the temporary access code you received right after you subscribed: ')),
					onChange: author$project$Main$RecordAccessCode,
					placeholder: elm$core$Maybe$Just(
						A2(
							mdgriffith$elm_ui$Element$Input$placeholder,
							_List_Nil,
							mdgriffith$elm_ui$Element$text('code or email address...'))),
				...
				_List_Nil,
				{
					...
					onPress: elm$core$Maybe$Just(author$project$Main$ProcessAccess)
				})
			]));
};
...
var author$project$Main$element_header = A2(
	mdgriffith$elm_ui$Element$column,
	_List_Nil,
	_List_fromArray(
		[
			...
			_List_fromArray(
				[
					...
					mdgriffith$elm_ui$Element$Font$color(
					A3(mdgriffith$elm_ui$Element$rgb255, 255, 120, 0)),
					mdgriffith$elm_ui$Element$Font$size(70),
					mdgriffith$elm_ui$Element$Font$bold,
					mdgriffith$elm_ui$Element$Font$italic
				]),
			mdgriffith$elm_ui$Element$text(' Grasp the Guitar Fretboard ')),
			A2(
			mdgriffith$elm_ui$Element$el,
			_List_fromArray(
				[
			...
			mdgriffith$elm_ui$Element$text('   Learn your way around the guitar fretboard and some other music theory fundamentals!   '))
		]));
var author$project$Main$aboutText = '\n\n\n*** IMPORTANT DISCLAIMER ***\nThis product is proposed as is. There is no promises made whatsoever.\nThe service can be modified or even discontinued at any time for any reason.\n(Although we will try to honor the remaining subscriptions until their expirations.)\nAs of now, if you see a value for yourself in this tool, you may want\nto support it with a payment that will certainly be helpful for us\nto continue its development.\n\n\n\n\n\nABOUT THIS ONLINE TOOL:\n\nIt is meant to help you visualize and then internalize the fretboard\nlayout and all the possible notes layout (scales, chords).\n\nStatic representations of the fretboard was not satisfying for us so\nwe came up with a solution to address that in the form of this online tool.\n\nIt can be tedious to find your way around the guitar fretboard sometimes.\nThe layout is not conceptually difficult to understand, but getting\na feel for it, and noticing all kinds of different relations between notes,\ntakes time. We are hoping that this tool could help speed up that process.\nOur goal is to make music theory concepts more intuitive and therefore\neasier to assimilate.\n\nWe intend to continue improving and growing this online tool\nif there are positive reactions and a noticeable interest in it.\n\nAs of now, this is an early stage product, you could call it\nan alpha release in software terms.\n\nIf you like this approach of visualization of the notes on\nthe guitar fretboard, and believe, like us, there is potential\nhere for more visualisations, you may want to help out by\nsubscribing. \n\nSharing the link to this website is helpful too.\n\nComments and suggestions for features are always welcomed.\n\nThank you for your visit.\n\n\n\n\n  ';
var author$project$Main$buyText = '\n\n*** IMPORTANT DISCLAIMER ***\nThis product is proposed as is. There is no promises made whatsoever.\nThe service can be modified or even discontinued at any time for any reason.\n(Although we will try to honor the remaining subscriptions until their expirations.)\nAs of now, if you see a value for yourself in this tool, you may want\nto support it with a payment that will certainly be helpful for us\nto continue its development.\n\n\nPrices:\n\n   Free:     just the free minimal tool as it is, no sign-up, no catch, always free.\n   Small:    $5/month subscription\n   Medium:  $15/month subscription\n   Premium: $40/month subscription\n\n\nWhat you get:\n   Free:\n     1 basic half fretboard, all the notes are displayed only over\n     half the conventional guitar fretboard.\n   Small:\n     1 basic full fretboard\n   Medium:\n     2 full fretboards\n   Premium:\n     Unlimited number of fretboards.\n\n\n   New features are created for the Premium subscribers and some of these\n   features may be passed down to the lower subscriptions later on, at some point.\n\n   Planned new features to come asap:\n     - different colors for selected and unselected notes\n     - Different tunings for each string, with a list of the classic tunings\n     - List of chords\n     - List of scales\n     -... and more...\n\n\nNote:\n   We are thinking to maybe make a special "Thank you" page where we would list\n   the name or pseudos or our contributors (if they want it). Let us know\n   if that\'s something you would like to see happen.\n\n\n   Please email us if you have preferences for features, requests and suggestions.\n   We pay attention to all the messages we receive.\n\n\n\n  ';
var author$project$Main$contactEmailAddress = 'info@pointblanklogic.com';
var author$project$Main$contactInfo = '\n\n\n  The most effective way to contact us for now is via email:\n\n';
var author$project$Main$homeText = 'Click on the notes you want selected, out of the 12 possible notes (agreed upon in western music),\nand they will be displayed on the following fretboard representations:\n\n  ';
var author$project$Main$mainAttributes = _List_fromArray(
	[
		mdgriffith$elm_ui$Element$width(mdgriffith$elm_ui$Element$fill),
		mdgriffith$elm_ui$Element$Background$color(
		A3(mdgriffith$elm_ui$Element$rgb255, 64, 161, 244)),
		mdgriffith$elm_ui$Element$Font$color(
		A3(mdgriffith$elm_ui$Element$rgb255, 0, 0, 0)),
		mdgriffith$elm_ui$Element$padding(20)
	]);
var author$project$Main$picsPath = './pics/';
var author$project$Main$AddRemove = F2(
	function (a, b) {
		return {$: 'AddRemove', a: a, b: b};
	});
var author$project$Main$get_color = F2(
	function (listOfNotes, the_note) {
		return A2(elm$core$List$member, the_note, listOfNotes) ? A3(mdgriffith$elm_ui$Element$rgb255, 0, 0, 255) : A3(mdgriffith$elm_ui$Element$rgb255, 255, 0, 0);
	});
...
var author$project$Main$render_the12Notes = F2(
	function (which12NotesList, the12NotesList) {
		return A2(
			mdgriffith$elm_ui$Element$column,
			_List_Nil,
			_List_fromArray(
					...
					_List_fromArray(
						[
							...
							_List_fromArray(
								[
									mdgriffith$elm_ui$Element$Background$color(
									A2(author$project$Main$get_color, the12NotesList, 'C')),
									mdgriffith$elm_ui$Element$Border$width(2),
									mdgriffith$elm_ui$Element$Border$color(
									A3(mdgriffith$elm_ui$Element$rgb255, 0, 0, 0))
								]),
							{
								label: mdgriffith$elm_ui$Element$text('C  '),
								onPress: elm$core$Maybe$Just(
									A2(author$project$Main$AddRemove, which12NotesList, 'C'))
							}),
							A2(
							mdgriffith$elm_ui$Element$Input$button,
							_List_fromArray(
							...
							_List_fromArray(
								[
									mdgriffith$elm_ui$Element$Background$color(
									A2(author$project$Main$get_color, the12NotesList, 'D')),
									mdgriffith$elm_ui$Element$Border$width(2),
									mdgriffith$elm_ui$Element$Border$color(
									A3(mdgriffith$elm_ui$Element$rgb255, 0, 0, 0))
								]),
							{
								label: mdgriffith$elm_ui$Element$text('D  '),
								onPress: elm$core$Maybe$Just(
									A2(author$project$Main$AddRemove, which12NotesList, 'D'))
							}),
							A2(
							mdgriffith$elm_ui$Element$Input$button,
							_List_fromArray(
							...
							_List_fromArray(
								[
									mdgriffith$elm_ui$Element$Background$color(
									A2(author$project$Main$get_color, the12NotesList, 'E')),
									mdgriffith$elm_ui$Element$Border$width(2),
									mdgriffith$elm_ui$Element$Border$color(
									A3(mdgriffith$elm_ui$Element$rgb255, 0, 0, 0))
								]),
							{
								label: mdgriffith$elm_ui$Element$text('E  '),
								onPress: elm$core$Maybe$Just(
									A2(author$project$Main$AddRemove, which12NotesList, 'E'))
							}),
							A2(
							mdgriffith$elm_ui$Element$Input$button,
							_List_fromArray(
								[
									mdgriffith$elm_ui$Element$Background$color(
									A2(author$project$Main$get_color, the12NotesList, 'F')),
									mdgriffith$elm_ui$Element$Border$width(2),
									mdgriffith$elm_ui$Element$Border$color(
									A3(mdgriffith$elm_ui$Element$rgb255, 0, 0, 0))
								]),
							{
								label: mdgriffith$elm_ui$Element$text('F  '),
								onPress: elm$core$Maybe$Just(
									A2(author$project$Main$AddRemove, which12NotesList, 'F'))
							}),
							A2(
							mdgriffith$elm_ui$Element$Input$button,
							_List_fromArray(
							...
							_List_fromArray(
								[
									mdgriffith$elm_ui$Element$Background$color(
									A2(author$project$Main$get_color, the12NotesList, 'G')),
									mdgriffith$elm_ui$Element$Border$width(2),
									mdgriffith$elm_ui$Element$Border$color(
									A3(mdgriffith$elm_ui$Element$rgb255, 0, 0, 0))
								]),
							{
								label: mdgriffith$elm_ui$Element$text('G  '),
								onPress: elm$core$Maybe$Just(
									A2(author$project$Main$AddRemove, which12NotesList, 'G'))
							}),
							A2(
							mdgriffith$elm_ui$Element$Input$button,
							_List_fromArray(
							...
							_List_fromArray(
								[
									mdgriffith$elm_ui$Element$Background$color(
									A2(author$project$Main$get_color, the12NotesList, 'A')),
									mdgriffith$elm_ui$Element$Border$width(2),
									mdgriffith$elm_ui$Element$Border$color(
									A3(mdgriffith$elm_ui$Element$rgb255, 0, 0, 0))
								]),
							{
								label: mdgriffith$elm_ui$Element$text('A  '),
								onPress: elm$core$Maybe$Just(
									A2(author$project$Main$AddRemove, which12NotesList, 'A'))
							}),
							A2(
							mdgriffith$elm_ui$Element$Input$button,
							_List_fromArray(
							...
							_List_fromArray(
								[
									mdgriffith$elm_ui$Element$Background$color(
									A2(author$project$Main$get_color, the12NotesList, 'B')),
									mdgriffith$elm_ui$Element$Border$width(2),
									mdgriffith$elm_ui$Element$Border$color(
									A3(mdgriffith$elm_ui$Element$rgb255, 0, 0, 0))
								]),
							{
								label: mdgriffith$elm_ui$Element$text('B  '),
								onPress: elm$core$Maybe$Just(
									A2(author$project$Main$AddRemove, which12NotesList, 'B'))
							})
						]))
				]));
	});
var author$project$Main$render_12notes = F2(
	function (model, which12NotesList) {
		var the12NotesList = A2(author$project$Main$select12NotesList, model, which12NotesList);
		return A2(author$project$Main$render_the12Notes, which12NotesList, the12NotesList);
	});
var author$project$Main$OneLessFretboard = {$: 'OneLessFretboard'};
var author$project$Main$OneMoreFretboard = {$: 'OneMoreFretboard'};
var author$project$Main$myButton = F2(
	function (theLabel, msg) {
		return A2(
			mdgriffith$elm_ui$Element$Input$button,
			_List_Nil,
			{
				label: mdgriffith$elm_ui$Element$text(theLabel),
				onPress: elm$core$Maybe$Just(msg)
			});
	});
var author$project$Main$render_addRemoveButton = function (model) {
	return A2(
		mdgriffith$elm_ui$Element$row,
		_List_Nil,
		_List_fromArray(
			[
				A2(author$project$Main$myButton, ' Add ', author$project$Main$OneMoreFretboard),
				A2(author$project$Main$myButton, ' Remove ', author$project$Main$OneLessFretboard)
			]));
};
var author$project$Main$render_all12Notes = function (model) {
	return A2(
		mdgriffith$elm_ui$Element$column,
		_List_Nil,
		A2(elm$core$List$indexedMap, author$project$Main$render_the12Notes, model.the12Notes));
};
var author$project$Main$string_A = 'A BC D EF G A BC D EF G A';
var author$project$Main$string_B = 'BC D EF G A BC D EF G A B';
var author$project$Main$string_D = 'D EF G A BC D EF G A BC D';
var author$project$Main$string_E = 'EF G A BC D EF G A BC D E';
var author$project$Main$string_G = 'G A BC D EF G A BC D EF G';
var author$project$Main$string_e = 'EF G A BC D EF G A BC D E';
var author$project$Main$guitarStrings = _List_fromArray(
	[author$project$Main$string_e, author$project$Main$string_B, author$project$Main$string_G, author$project$Main$string_D, author$project$Main$string_A, author$project$Main$string_E]);
var author$project$Main$render_cell = F4(
	function (model, indexFretPosition, guitarString, which12NotesList) {
		var the_note = (A3(elm$core$String$slice, indexFretPosition, indexFretPosition + 1, guitarString) === ' ') ? (A3(elm$core$String$slice, indexFretPosition - 1, indexFretPosition, guitarString) + '#') : A3(elm$core$String$slice, indexFretPosition, indexFretPosition + 1, guitarString);
		var the12NotesList = A2(author$project$Main$select12NotesList, model, which12NotesList);
		return (_Utils_eq(model.paidStatus, author$project$Main$Free) && (indexFretPosition > 12)) ? A2(
			mdgriffith$elm_ui$Element$el,
			_List_fromArray(
				[
					mdgriffith$elm_ui$Element$Background$color(
					A3(mdgriffith$elm_ui$Element$rgb255, 100, 0, 0)),
					mdgriffith$elm_ui$Element$Border$width(2),
					mdgriffith$elm_ui$Element$Border$color(
					A3(mdgriffith$elm_ui$Element$rgb255, 0, 0, 0))
				]),
			mdgriffith$elm_ui$Element$text(
				A3(elm$core$String$slice, indexFretPosition, indexFretPosition + 1, guitarString))) : A2(
			mdgriffith$elm_ui$Element$el,
			_List_fromArray(
				[
					mdgriffith$elm_ui$Element$Background$color(
					A2(author$project$Main$get_color, the12NotesList, the_note)),
					mdgriffith$elm_ui$Element$Border$width(2),
					mdgriffith$elm_ui$Element$Border$color(
					A3(mdgriffith$elm_ui$Element$rgb255, 0, 0, 0))
				]),
			mdgriffith$elm_ui$Element$text(
				A3(elm$core$String$slice, indexFretPosition, indexFretPosition + 1, guitarString)));
	});
...
var author$project$Main$render_fretboard = F2(
	function (model, which12NotesList) {
		return A2(
			...
			_List_fromArray(
				[
					mdgriffith$elm_ui$Element$Background$color(
					A3(mdgriffith$elm_ui$Element$rgb255, 164, 161, 244)),
					mdgriffith$elm_ui$Element$Font$color(
					A3(mdgriffith$elm_ui$Element$rgb255, 90, 0, 0)),
				...
				]),
			{
				columns: _List_fromArray(
					[
						{
						header: mdgriffith$elm_ui$Element$text('Open'),
						view: function (guitarString) {
							return A4(author$project$Main$render_cell, model, 0, guitarString, which12NotesList);
						},
						width: mdgriffith$elm_ui$Element$fill
					},
						{
						header: mdgriffith$elm_ui$Element$text('1'),
						view: function (guitarString) {
							return A4(author$project$Main$render_cell, model, 1, guitarString, which12NotesList);
						},
						width: mdgriffith$elm_ui$Element$fill
					},
						{
						header: mdgriffith$elm_ui$Element$text('2'),
						view: function (guitarString) {
							return A4(author$project$Main$render_cell, model, 2, guitarString, which12NotesList);
						},
						width: mdgriffith$elm_ui$Element$fill
					},
						{
						header: mdgriffith$elm_ui$Element$text('*3'),
						view: function (guitarString) {
							return A4(author$project$Main$render_cell, model, 3, guitarString, which12NotesList);
						},
						width: mdgriffith$elm_ui$Element$fill
					},
						{
						header: mdgriffith$elm_ui$Element$text('4'),
						view: function (guitarString) {
							return A4(author$project$Main$render_cell, model, 4, guitarString, which12NotesList);
						},
						width: mdgriffith$elm_ui$Element$fill
					},
						{
						header: mdgriffith$elm_ui$Element$text('*5'),
						view: function (guitarString) {
							return A4(author$project$Main$render_cell, model, 5, guitarString, which12NotesList);
						},
						width: mdgriffith$elm_ui$Element$fill
					},
						{
						header: mdgriffith$elm_ui$Element$text('6'),
						view: function (guitarString) {
							return A4(author$project$Main$render_cell, model, 6, guitarString, which12NotesList);
						},
						width: mdgriffith$elm_ui$Element$fill
					},
						{
						header: mdgriffith$elm_ui$Element$text('*7'),
						view: function (guitarString) {
							return A4(author$project$Main$render_cell, model, 7, guitarString, which12NotesList);
						},
						width: mdgriffith$elm_ui$Element$fill
					},
						{
						header: mdgriffith$elm_ui$Element$text('8'),
						view: function (guitarString) {
							return A4(author$project$Main$render_cell, model, 8, guitarString, which12NotesList);
						},
						width: mdgriffith$elm_ui$Element$fill
					},
						{
						header: mdgriffith$elm_ui$Element$text('*9'),
						view: function (guitarString) {
							return A4(author$project$Main$render_cell, model, 9, guitarString, which12NotesList);
						},
						width: mdgriffith$elm_ui$Element$fill
					},
						{
						header: mdgriffith$elm_ui$Element$text('10'),
						view: function (guitarString) {
							return A4(author$project$Main$render_cell, model, 10, guitarString, which12NotesList);
						},
						width: mdgriffith$elm_ui$Element$fill
					},
						{
						header: mdgriffith$elm_ui$Element$text('11'),
						view: function (guitarString) {
							return A4(author$project$Main$render_cell, model, 11, guitarString, which12NotesList);
						},
						width: mdgriffith$elm_ui$Element$fill
					},
						{
						header: mdgriffith$elm_ui$Element$text('**12'),
						view: function (guitarString) {
							return A4(author$project$Main$render_cell, model, 12, guitarString, which12NotesList);
						},
						width: mdgriffith$elm_ui$Element$fill
					}
					]),
				data: author$project$Main$guitarStrings
			});
	});
var author$project$Main$render_theFretboard = F3(
	function (model, which12NotesList, the12Notes) {
		return A2(author$project$Main$render_fretboard, model, which12NotesList);
	});
var author$project$Main$render_allFretboard = function (model) {
	return A2(
		mdgriffith$elm_ui$Element$column,
		_List_fromArray(
			[
		...
		A2(
			elm$core$List$indexedMap,
			author$project$Main$render_theFretboard(model),
			model.the12Notes));
};
var author$project$Main$render_fretboard2 = F2(
	function (model, which12NotesList) {
		return A2(
			mdgriffith$elm_ui$Element$table,
			_List_fromArray(
				...
				]),
			{
				columns: _List_fromArray(
					[
						...
						{
						header: mdgriffith$elm_ui$Element$text('13'),
						view: function (guitarString) {
							return A4(author$project$Main$render_cell, model, 13, guitarString, which12NotesList);
						},
						width: mdgriffith$elm_ui$Element$fill
					},
						{
						header: mdgriffith$elm_ui$Element$text('14'),
						view: function (guitarString) {
							return A4(author$project$Main$render_cell, model, 14, guitarString, which12NotesList);
						},
						width: mdgriffith$elm_ui$Element$fill
					},
						{
						header: mdgriffith$elm_ui$Element$text('*15'),
						view: function (guitarString) {
							return A4(author$project$Main$render_cell, model, 15, guitarString, which12NotesList);
						},
						width: mdgriffith$elm_ui$Element$fill
					},
						{
						header: mdgriffith$elm_ui$Element$text('16'),
						view: function (guitarString) {
							return A4(author$project$Main$render_cell, model, 16, guitarString, which12NotesList);
						},
						width: mdgriffith$elm_ui$Element$fill
					},
						{
						header: mdgriffith$elm_ui$Element$text('*17'),
						view: function (guitarString) {
							return A4(author$project$Main$render_cell, model, 17, guitarString, which12NotesList);
						},
						width: mdgriffith$elm_ui$Element$fill
					},
						{
						header: mdgriffith$elm_ui$Element$text('18'),
						view: function (guitarString) {
							return A4(author$project$Main$render_cell, model, 18, guitarString, which12NotesList);
						},
						width: mdgriffith$elm_ui$Element$fill
					},
						{
						header: mdgriffith$elm_ui$Element$text('*19'),
						view: function (guitarString) {
							return A4(author$project$Main$render_cell, model, 19, guitarString, which12NotesList);
						},
						width: mdgriffith$elm_ui$Element$fill
					},
						{
						header: mdgriffith$elm_ui$Element$text('20'),
						view: function (guitarString) {
							return A4(author$project$Main$render_cell, model, 20, guitarString, which12NotesList);
						},
						width: mdgriffith$elm_ui$Element$fill
					},
						{
						header: mdgriffith$elm_ui$Element$text('*21'),
						view: function (guitarString) {
							return A4(author$project$Main$render_cell, model, 21, guitarString, which12NotesList);
						},
						width: mdgriffith$elm_ui$Element$fill
					},
						{
						header: mdgriffith$elm_ui$Element$text('22'),
						view: function (guitarString) {
							return A4(author$project$Main$render_cell, model, 22, guitarString, which12NotesList);
						},
						width: mdgriffith$elm_ui$Element$fill
					},
						{
						header: mdgriffith$elm_ui$Element$text('23'),
						view: function (guitarString) {
							return A4(author$project$Main$render_cell, model, 23, guitarString, which12NotesList);
						},
						width: mdgriffith$elm_ui$Element$fill
					},
						{
						header: mdgriffith$elm_ui$Element$text('**24'),
						view: function (guitarString) {
							return A4(author$project$Main$render_cell, model, 24, guitarString, which12NotesList);
						},
						width: mdgriffith$elm_ui$Element$fill
					}
					]),
...
var author$project$Main$render_theFretboard2 = F3(
	function (model, which12NotesList, the12Notes) {
		return A2(author$project$Main$render_fretboard2, model, which12NotesList);
	});
var author$project$Main$render_allFretboard2 = function (model) {
	return A2(
		mdgriffith$elm_ui$Element$column,
		_List_Nil,
		A2(
			elm$core$List$indexedMap,
			author$project$Main$render_theFretboard2(model),
			model.the12Notes));
};
...
var author$project$Main$element_main = function (model) {
	var _n0 = model.currentPage;
	switch (_n0.$) {
		case 'Home':
			return A2(
				mdgriffith$elm_ui$Element$column,
				author$project$Main$mainAttributes,
				_List_fromArray(
					[
						mdgriffith$elm_ui$Element$text(author$project$Main$homeText),
						function () {
						var _n1 = model.paidStatus;
						switch (_n1.$) {
							case 'Free':
								return A2(
									mdgriffith$elm_ui$Element$column,
									...
									_List_fromArray(
										[
											A2(author$project$Main$render_12notes, model, 0),
											A2(author$project$Main$render_fretboard, model, 0),
											A2(author$project$Main$render_fretboard2, model, 0)
										]));
							case 'Small':
								return A2(
									mdgriffith$elm_ui$Element$column,
							...
							case 'Medium':
								return A2(
									...
									_List_fromArray(
										[
											A2(author$project$Main$render_12notes, model, 0),
											A2(author$project$Main$render_12notes, model, 1),
											A2(author$project$Main$render_fretboard, model, 0),
											A2(author$project$Main$render_fretboard, model, 1),
											A2(author$project$Main$render_fretboard2, model, 0),
											A2(author$project$Main$render_fretboard2, model, 1)
										]));
							default:
								return A2(
									mdgriffith$elm_ui$Element$column,
									...
									_List_fromArray(
										[
											author$project$Main$render_addRemoveButton(model),
											author$project$Main$render_all12Notes(model),
											author$project$Main$render_allFretboard(model),
											author$project$Main$render_allFretboard2(model)
										]));
						}
					}(),
						A2(
						...
						{description: 'Playing guitar is chilling', src: author$project$Main$picsPath + 'caio-henrique-C7RFkKvThG4-unsplash.jpg'})
					]));
		case 'Buy':
			return A2(
				mdgriffith$elm_ui$Element$column,
				...
				_List_fromArray(
					[
						mdgriffith$elm_ui$Element$text(author$project$Main$buyText)
					]));
		case 'About':
			return A2(
				mdgriffith$elm_ui$Element$column,
				...
				_List_fromArray(
					[
						mdgriffith$elm_ui$Element$text(author$project$Main$aboutText),
						A2(
						mdgriffith$elm_ui$Element$image,
						_List_fromArray(
							[
		...
		default:
			return A2(
				...
				_List_fromArray(
					[
						mdgriffith$elm_ui$Element$text(author$project$Main$contactInfo),
						mdgriffith$elm_ui$Element$text(author$project$Main$contactEmailAddress),
						mdgriffith$elm_ui$Element$text(''),
						A2(
						mdgriffith$elm_ui$Element$image,
						_List_fromArray(
...
var author$project$Main$GoBuy = {$: 'GoBuy'};
var author$project$Main$GoContactInfo = {$: 'GoContactInfo'};
var author$project$Main$GoHome = {$: 'GoHome'};
var author$project$Main$element_nav = A2(
	mdgriffith$elm_ui$Element$row,
	_List_fromArray(
		[
	...
	_List_fromArray(
		[
			A2(author$project$Main$myButton, 'Fretboard', author$project$Main$GoHome),
			A2(author$project$Main$myButton, 'Prices', author$project$Main$GoBuy),
			A2(author$project$Main$myButton, 'About', author$project$Main$GoAbout),
			A2(author$project$Main$myButton, 'Contact', author$project$Main$GoContactInfo)
		]));
...
var mdgriffith$elm_ui$Element$layout = mdgriffith$elm_ui$Element$layoutWith(
	{options: _List_Nil});
var author$project$Main$compose_page = function (model) {
	return A2(
		...
		_List_fromArray(
			[
				...
				A3(mdgriffith$elm_ui$Element$rgb255, 0, 0, 0)),
				mdgriffith$elm_ui$Element$Font$color(
				A3(mdgriffith$elm_ui$Element$rgb255, 255, 200, 0))
			]),
		A2(
			mdgriffith$elm_ui$Element$column,
			_List_Nil,
			_List_fromArray(
				[
					author$project$Main$element_header,
					author$project$Main$element_nav,
					author$project$Main$element_main(model),
					author$project$Main$element_display_confirmation(model.confirmation),
					author$project$Main$element_formAccessCode(model),
					author$project$Main$element_footer(model)
				])));
};
		...
		case 'Home':
			return {
				body: _List_fromArray(
					[
						author$project$Main$compose_page(model)
					]),
